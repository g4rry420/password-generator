...
function App() {
  ...
  const [decreaseValue, setDecreaseValue] = useState(31);
  ...
  useEffect(() => {
    ...
    else if(slideValue < 28){
      passwordRef.current.style.fontSize = "32px";
    }
  ...
  const slideChanger = (e) => {
    ...
    if((slideValue > targetValue ) && (decreaseValue !== 32)){
      passwordRef.current.style.fontSize = `${decreaseValue}px`
      setDecreaseValue(decreaseValue + 1)
    }
  ...
  return (
    <div className="App">
      <div className="main-container">
        ...
        <main className="password-gen-container">
          <div>
            <div ref={passwordRef} className="password"> {password} </div>
            <div>
              <div onClick={checkedFunc} className="reset-pass"></div>
              <div className="copy-pass">Copy&nbsp;Password</div>
            </div>
          </div>
          <div className="labels-container">
            <span className="pass-label-icon icon"></span>
            <span className="pass-label">Strong Password</span>
          </div>
        </main>
